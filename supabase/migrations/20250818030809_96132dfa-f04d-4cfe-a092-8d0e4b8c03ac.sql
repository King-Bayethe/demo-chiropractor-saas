...
('11111111-1111-1111-1111-111111111111'::uuid, 'Michael', 'Rodriguez', 'michael.rodriguez@email.com', '555-0101', '1995-03-15', 'Male', '123 Sports Ave', 'Denver', 'CO', '80205', 'Athletic Health Insurance', 'AHI-789456', 'Maria Rodriguez', '555-0102', 'ghl_001', true, ARRAY['athlete', 'soccer', 'knee-injury']),
('22222222-2222-2222-2222-222222222222'::uuid, 'Sarah', 'Chen', 'sarah.chen@email.com', '555-0201', '1978-11-22', 'Female', '456 Office Blvd', 'Austin', 'TX', '73301', 'Corporate Health Plan', 'CHP-456789', 'David Chen', '555-0202', 'ghl_002', true, ARRAY['chronic-pain', 'office-worker', 'back-pain']),
('33333333-3333-3333-3333-333333333333'::uuid, 'Robert', 'Johnson', 'robert.johnson@email.com', '555-0301', '1952-07-08', 'Male', '789 Retirement Ln', 'Phoenix', 'AZ', '85001', 'Medicare Plus', 'MP-123456', 'Betty Johnson', '555-0302', 'ghl_003', true, ARRAY['post-surgical', 'knee-replacement', 'elderly']),
('44444444-4444-4444-4444-444444444444'::uuid, 'Emma', 'Thompson', 'emma.thompson@email.com', '555-0401', '2015-04-12', 'Female', '321 Family St', 'Portland', 'OR', '97201', 'Pediatric Care Insurance', 'PCI-987654', 'Lisa Thompson', '555-0402', 'ghl_004', true, ARRAY['pediatric', 'asthma', 'child']),
('55555555-5555-5555-5555-555555555555'::uuid, 'William', 'Davis', 'william.davis@email.com', '555-0501', '1943-12-03', 'Male', '654 Senior Way', 'Miami', 'FL', '33101', 'Senior Health Network', 'SHN-147258', 'Dorothy Davis', '555-0502', 'ghl_005', true, ARRAY['hypertension', 'diabetes', 'senior']),
('66666666-6666-6666-6666-666666666666'::uuid, 'Jennifer', 'Wilson', 'jennifer.wilson@email.com', '555-0601', '1987-09-14', 'Female', '987 Corporate Dr', 'Chicago', 'IL', '60601', 'Executive Health Plan', 'EHP-369258', 'Mark Wilson', '555-0602', 'ghl_006', true, ARRAY['migraine', 'stress', 'executive']),
('77777777-7777-7777-7777-777777777777'::uuid, 'Amanda', 'Garcia', 'amanda.garcia@email.com', '555-0701', '1992-01-28', 'Female', '147 Maternity Ave', 'San Diego', 'CA', '92101', 'Maternity Care Plus', 'MCP-741852', 'Carlos Garcia', '555-0702', 'ghl_007', true, ARRAY['pregnancy', 'prenatal', 'healthy']),
('88888888-8888-8888-8888-888888888888'::uuid, 'James', 'Miller', 'james.miller@email.com', '555-0801', '1985-06-19', 'Male', '258 Construction St', 'Dallas', 'TX', '75201', 'Workers Compensation', 'WC-852963', 'Linda Miller', '555-0802', 'ghl_008', true, ARRAY['workplace-injury', 'shoulder', 'construction']);
...
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa'::uuid, 'Orthopedic Knee Evaluation', 'Comprehensive knee assessment template for sports injuries and general orthopedic conditions', 'Orthopedics', '🦴', 'Orthopedic Surgery', ARRAY['knee', 'sports injury', 'orthopedic', 'ligament', 'meniscus'], ARRAY['adolescent', 'adult'], 'medium', 
'{
...
('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb'::uuid, 'Sports Medicine Assessment', 'Comprehensive evaluation for athletic injuries and performance optimization', 'Sports Medicine', '⚽', 'Sports Medicine', ARRAY['sports', 'athletic injury', 'performance', 'concussion'], ARRAY['adolescent', 'adult'], 'high', 
'{
...
('cccccccc-cccc-cccc-cccc-cccccccccccc'::uuid, 'Chronic Pain Management', 'Comprehensive evaluation for patients with chronic pain conditions', 'Pain Management', '🎯', 'Pain Medicine', ARRAY['chronic pain', 'pain management', 'functional assessment'], ARRAY['adult', 'senior'], 'medium', 
'{
...
('s1111111-1111-1111-1111-111111111111'::uuid, '11111111-1111-1111-1111-111111111111'::uuid, (SELECT id FROM auth.users LIMIT 1), 'Dr. Sarah Silverman', NULL, '2024-01-15 10:00:00', 'Right knee pain and swelling after soccer injury', false,
'{
...
('s2222222-2222-2222-2222-222222222222'::uuid, '22222222-2222-2222-2222-222222222222'::uuid, (SELECT id FROM auth.users LIMIT 1), 'Dr. Michael Thompson', NULL, '2024-01-18 14:30:00', 'Chronic lower back pain, worsening over past month', false,
'{
...
('s4444444-4444-4444-4444-444444444444'::uuid, '44444444-4444-4444-4444-444444444444'::uuid, (SELECT id FROM auth.users LIMIT 1), 'Dr. Lisa Pediatric', NULL, '2024-01-22 11:00:00', 'Asthma follow-up and medication adjustment', true,
'{
...
('u1111111-1111-1111-1111-111111111111'::uuid, 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa'::uuid, 'Orthopedic Knee Evaluation', 'custom', (SELECT id FROM auth.users LIMIT 1), '11111111-1111-1111-1111-111111111111', 'Right knee pain and swelling after soccer injury', 
'{
  "effectiveness": "high",
...
('u2222222-2222-2222-2222-222222222222'::uuid, 'cccccccc-cccc-cccc-cccc-cccccccccccc'::uuid, 'Chronic Pain Management', 'custom', (SELECT id FROM auth.users LIMIT 1), '22222222-2222-2222-2222-222222222222', 'Chronic lower back pain, worsening over past month', 
'{
  "effectiveness": "high",
