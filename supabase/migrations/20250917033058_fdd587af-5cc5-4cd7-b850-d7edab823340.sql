...
-- Execute in correct order to handle ALL foreign key dependencies
...
-- Priority 2: Clear form submissions and opportunities (they reference patients)
...
-- Priority 7: Clear rate limiting data
