-- Create function to sync new patient to GHL
...
-- Create trigger to automatically sync new patients to GHL
DROP TRIGGER IF EXISTS trigger_sync_patient_to_ghl ON public.patients;
CREATE TRIGGER trigger_sync_patient_to_ghl
  AFTER INSERT ON public.patients
  FOR EACH ROW
  EXECUTE FUNCTION public.sync_patient_to_ghl();