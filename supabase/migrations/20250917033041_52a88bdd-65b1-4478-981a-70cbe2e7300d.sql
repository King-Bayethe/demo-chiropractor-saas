...
-- Execute in correct order to handle foreign key dependencies
...
-- Priority 2: Clear opportunities before patients (due to foreign key)
DELETE FROM public.opportunities;

-- Priority 3: Clear remaining main user data tables
DELETE FROM public.appointments;
DELETE FROM public.soap_notes;
DELETE FROM public.patients;
DELETE FROM public.documents;

-- Priority 4: Clear form submission related data
...
-- Priority 8: Clear rate limiting data (will reset automatically)
