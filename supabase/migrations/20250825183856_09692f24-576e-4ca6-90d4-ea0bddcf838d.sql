-- Create function to automatically create patients from form submissions
...
-- Create trigger to automatically create patients from form submissions
DROP TRIGGER IF EXISTS create_patient_from_form_trigger ON public.form_submissions;
CREATE TRIGGER create_patient_from_form_trigger
  AFTER INSERT ON public.form_submissions
  FOR EACH ROW
  EXECUTE FUNCTION public.create_patient_from_form_submission();